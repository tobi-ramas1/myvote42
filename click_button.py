...
mobile_user_agent = "Mozilla/5.0 (Linux; Android 14; Pixel 8 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Mobile Safari/537.36"
...
try:
    ...
    driver.add_cookie({'name': 'PHPSESSID', 'value': 'a933e509785cdbf597328982a2f486ec'})
    time.sleep(2)
    # to refresh the page
    driver.refresh()
